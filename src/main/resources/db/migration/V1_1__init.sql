...
CREATE TABLE T_LISTING_PRICE_ADJUST_HISTORY  --leave a history record each time T_LISTING's price is adjusted, useful for analysis purpose
(
  ID BIGINT PRIMARY KEY NOT NULL,
...
CREATE TABLE M_LOCATION_HIERARCHY  -- store location hierarchy country/city/area for search purpose
(
  ID BIGINT PRIMARY KEY NOT NULL,
  NAME VARCHAR(100),
  DESCRIPTION VARCHAR(500),
